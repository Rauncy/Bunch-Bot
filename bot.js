...
bot.on('message', (message) => {
  ...
  //N word
  var nWordRegex = /\b(n[ilo0]+)[bg🅱️]+[era]*(s*)\b/gi;
  ...
  var despacitoRegex = /de+sp[ai]+h*[sc]?i+toh?/;
/*
...
*/
  ...
  if(!message.author.bot && despacitoRegex.test(t)) message.channel.send("<@"+message.author.id+">, do you mean \"Nigger\"?");
